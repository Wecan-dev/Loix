    ...
    <div class="main-banner__item">
      <div class="mask">
        <div class="main-banner__text">
         ...
         ?> 
           <?php if (get_theme_mod('women_banner_slider_texto_del_boton') != NULL){?>  
          <a class="btn_custom"
        href="<?php echo get_theme_mod('women_banner_slider_url_del_boton') ?>"><?php echo get_theme_mod('women_banner_slider_texto_del_boton') ?></a>
