...
<body>
  <header class="header__main navbar-me back container-fluid">
    ...
    <div class="menu_principal">
      ...
      <nav class="nav__menu">
        ...
        <div class="logo2">
         <a  class="logo-main" href="<?php bloginfo('url') ?>"> <img src="assets/images/logo2.png" alt="logo"> </a>
       </div>
       <div class="  main_menu">
  ...
  <div class="nav-item">
    ...
    <a class="nav-link" href="#about">COMUNIDAD</a>

  </div>
  <div class="nav-item">

    <a class="nav-link" href="#about">GIVE BACK</a>

  </div>
  <div class="nav-item">

    <a class="nav-link" href="#about">ESCANEA NUESTRO<br>CÓDIGO QR</a>

  </div>
  <div class="nav-item">

    <a class="nav-link" href="#about">SERVICIO AL CLIENTE</a>

  </div>
  <div class="nav-item">

    <a class="nav-link" href="#about">OUTLET</a>
  ...
  <div class="nav-item ">
    ...
    <a  class="nav-link this" href="#about">+INFO</a>
...
<div class="logo ">
 <a  class="logo-main" href="<?php bloginfo('url') ?>"> <img src="assets/images/logo.png" alt="logo"> </a>
</div>   
</div>
...
<div class="login  ">
 ...
 <div class="blog-page" style="background-color: #fff!important; ">
  ...
  <div class="header "  style="background-image: url(assets/images/banner.png);">
    <div class="mask-blog">
...
<section id="about" class="container impacto">
  <div class="impacto_child">
    <div class="impacto_child_img">
          <div class="card-cate">
          <div class="img-cate">
            <img style="width: 100%;" src="assets/images/catalogo.png">
            <div class="text-cate">
